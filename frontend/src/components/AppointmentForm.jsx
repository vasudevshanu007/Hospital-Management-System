  ...
  useEffect(() => {
    const fetchDoctors = async () => {
      const { data } = await axios.get(
        "https://vasudev-hospital-management-system.onrender.com/api/v1/user/doctors",
  ...
  const handleAppointment = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://vasudev-hospital-management-system.onrender.com/api/v1/appointment/post",
        {
          firstName,
          lastName,
          email,
